...
以上信息也可见于[这微信页](https://mp.weixin.qq.com/s/KGkTkcRh7dO1UmB8REKMtw)。

### 5. 提交初审材料

1. 团队代码必须在 Github 提交 PR 到本 repo ([**parity-asia** 组织](https://github.com/parity-asia) 下的)。在注册的第一周，团队应该复制这个代码存储库并创建一个团队目录。在 README 文件中，列出计划在黑客马拉松期间完成的代码功能(不超过 1000 字)，并向 Parity Github 提交 pull request (PR);

2. 每个团队必须提交至少一件参赛作品，所有团队必须提交英文版本的作品。
