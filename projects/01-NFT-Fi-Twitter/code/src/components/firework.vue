<script>
// credit: https://github.com/dampion/Vue-damp-fireworks/blob/master/src/components/fireworks.vue
export default {
  props: {
    boxHeight: {
      type: Number,
...
<template>
  <div
    class="vue-damp-fireworks-wrap" :style="`
      height: ${canvasBoxHeight};
        width: ${canvasBoxWidth};
    `"
  >
    <div v-show="show" class="canvasBox">
      <canvas id="canvas" />
    </div>
    <slot />
  </div>
