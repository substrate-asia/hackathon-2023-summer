...
type WriteContractArgs<TAbi extends ABI, TFunctionName extends string>
    = WriteContractUnpreparedArgs<TAbi, TFunctionName> | WriteContractPreparedArgs<TAbi, TFunctionName>
...
export class WagmiContract<TAbi extends ABI> {
    ...
    async prepareWrite<TFunctionName extends string, TChainId extends number, TSigner extends Signer>(
        functionName: AbiFunctionWrite<TAbi, TFunctionName>,
        args: AbiArgs<TAbi, TFunctionName>,
        config?: Omit<PrepareWriteContractConfig<TAbi, TFunctionName, TChainId, TSigner>, AAFA>,
    ...
    async unpreparedWrite<TFunctionName extends string, TChainId extends number, TSigner extends Signer>(
        functionName: AbiFunctionWrite<TAbi, TFunctionName>,
        args: AbiArgs<TAbi, TFunctionName>,
