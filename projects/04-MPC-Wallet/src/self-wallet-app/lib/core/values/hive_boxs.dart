...
// 应用设置
const appSettingBox = 'appSettingTutorial';
// 钱包信息
const walletDataBox = 'walletTutorial';

/// 本地存储的keys
class LocalKeyList {
  static String networkList = "network-list";
  static String networkHash = "network-hash";
  static String netPrefix = "net-";
  static String tokenList = "token-list";
