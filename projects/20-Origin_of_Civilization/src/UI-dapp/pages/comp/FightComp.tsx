    ...
    return(
      <div className={styles.card}>
        <div className={styles.inCardContainer}>
          ...
          <div className={styles.inCarddescription}>
            <p>
            Enter the address of the enemy.
            </p>
          </div>


          <div>
            <input type="text" name='username' defaultValue="0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045" className={styles.inputbox} onChange={e => setTargetAddress(e.target.value)}/> 
          </div>
