defmodule EvmscanApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EvmscanApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EvmscanApiWeb.Gettext, "errors", msg, opts)
    end
  end
