...
from models.model import Site, App
...
def parse_app_site_args():
    ...
    parser.add_argument('customize_domain', type=str,
                        required=False, location='json')
    parser.add_argument('copyright', type=str, required=False, location='json')
    parser.add_argument('privacy_policy', type=str,
                        required=False, location='json')
    parser.add_argument('customize_token_strategy', type=str, choices=['must', 'allow', 'not_allow'],
                        required=False,
                        location='json')
    parser.add_argument('prompt_public', type=bool,
                        required=False, location='json')
    
    parser.add_argument('public_for_lumi', type=bool,
                        required=False, location='json')
        
    parser.add_argument('brief_description', type=str,
                        required=False, location='json')
...
class AppSite(Resource):
    ...
    def post(self, app_id):
        ...
        for attr_name in [
            ...
            logging.debug("%s %s",attr_name,value)
...
class AppSiteAccessTokenReset(Resource):
    ...
    def post(self, app_id):
        ...
        site = db.session.query(Site).filter(
            Site.app_id == app_model.id).first()
...
api.add_resource(AppSiteAccessTokenReset,
