from extensions.ext_rate_limiter import GLOBAL_RATE_LIMITS_CHAT_ERROR_MESSGAE, api_rate_limiter, GLOBAL_RATE_LIMITS_CHAT, get_key_for_chat_messages_api, get_key_for_completion_messages_api
import json
import logging
