  ...
  return (
    <>
      <div className="w-full mx-auto">
        ...
        <h2 className="text-3xl font-normal text-gray-900">{t('login.welcome')}</h2>
        ...
        <div className="bg-white ">
          ...
          {/* <div className="block mt-6 text-xs text-gray-600">
            ...
            <Link
              ...
              target={'_blank'}
              href='https://doc.web3go.xyz/ai/user-agreement/terms-of-service'
            >{t('login.tos')}</Link>
            &nbsp;&&nbsp;
            <Link
              className='text-primary-600'
              target={'_blank'}
              href='https://doc.web3go.xyz/ai/user-agreement/privacy-policy'
            >{t('login.pp')}</Link>
          </div> */}
