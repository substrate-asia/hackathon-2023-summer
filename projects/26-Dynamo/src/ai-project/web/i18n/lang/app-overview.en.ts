  ...
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        webBriefDesc: 'WebApp Brief Description',
        ...
        webBriefDescPlaceholder: 'Enter the brief description of the WebApp',
        webPublicToLumiDesc: 'WebApp Will be public to Lumi',
        language: 'Language',
        more: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Dynamo-WebClient',
