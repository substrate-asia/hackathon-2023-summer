const translation = {
  ...
  account: {
    ...
    name: 'Name',
    email: 'Email',
    langGeniusAccount: 'Dynamo account',
    langGeniusAccountTip: 'Your Dynamo account and associated user data.',
    editName: 'Edit Name',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Dynamo allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'Dynamo {{version}} is now available.',
    latestAvailable: 'Dynamo {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
    promptEng: 'Prompt',
