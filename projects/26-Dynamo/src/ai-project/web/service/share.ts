...
// async call for current user to notify external services by kafka message
export const chatAppStart = async (isInstalledApp: boolean, installedAppId = '') => {
  // isInstalledApp=false
  // return (getAction('post', isInstalledApp))(getUrl('chatapp-start', isInstalledApp, installedAppId))
}
