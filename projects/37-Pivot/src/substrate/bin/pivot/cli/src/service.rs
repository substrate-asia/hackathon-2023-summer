...
pub struct NewFullBase {
	/// The task manager of the pivot.
	pub task_manager: TaskManager,
	/// The client instance of the pivot.
	pub client: Arc<FullClient>,
	/// The networking service of the pivot.
	pub network: Arc<NetworkService<Block, <Block as BlockT>::Hash>>,
	/// The syncing service of the pivot.
	pub sync: Arc<SyncingService<Block>>,
	/// The transaction pool of the pivot.
	pub transaction_pool: Arc<TransactionPool>,
	/// The rpc handlers of the pivot.
...
pub fn new_full_base(
	...
	// if the pivot isn't actively participating in consensus then it doesn't
...
mod tests {
	...
	#[test]
	// It is "ignored", but the pivot-cli ignored tests are running on the CI.
	// This can be run locally with `cargo test --release -p pivot-cli test_sync -- --ignored`.
	#[ignore]
	fn test_sync() {
