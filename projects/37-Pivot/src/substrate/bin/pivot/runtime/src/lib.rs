...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("substrate-pivot"),
...
impl pallet_bags_list::Config<VoterBagsListInstance> for Runtime {
	...
	/// of each pivot is the staking pallet.
...
///
/// When you change this, you **MUST** modify [`sign`] in `bin/pivot/testing/src/keyring.rs`!
///
