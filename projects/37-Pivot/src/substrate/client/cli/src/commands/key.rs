...
pub enum KeySubcommand {
	/// Generate a random pivot key, write it to a file or stdout and write the
	...
	/// Load a pivot key from a file or stdin and print the corresponding peer-id
	InspectNodeKey(InspectNodeKeyCmd),

	/// Insert a key to the keystore of a pivot.
	Insert(InsertKeyCmd),
}
