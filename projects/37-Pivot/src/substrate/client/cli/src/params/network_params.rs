...
pub struct NetworkParams {
	...
	/// Specify a list of reserved pivot addresses.
	#[arg(long, value_name = "ADDR", num_args = 1..)]
	...
	/// In particular, if you are a validator your pivot might still connect to other
	...
	/// This can be used if there's a proxy in front of this pivot.
