...
fn state_access_benchmarks(c: &mut Criterion) {
	...
	bench_multiple_values(
		...
		"with trie pivot cache and reading each key once",
		1,
	);
	...
	bench_multiple_values(
		BenchmarkConfig::TrieNodeCache,
		"with trie pivot cache and reading 4 times each key in a row",
		4,
	);
	bench_multiple_values(
	...
	bench_single_value(
		BenchmarkConfig::TrieNodeCache,
		"with trie pivot cache and reading the key once",
		1,
	);
	...
	bench_single_value(
		BenchmarkConfig::TrieNodeCache,
		"with trie pivot cache and hashing the key once",
		1,
	);
	...
	bench_single_value(
		BenchmarkConfig::TrieNodeCache,
		"with trie pivot cache and hashing 4 times each key in a row",
		4,
	);
	bench_single_value(
		BenchmarkConfig::NoCache,
	...
	bench_single_value(BenchmarkConfig::TrieNodeCache, "with trie pivot cache");
