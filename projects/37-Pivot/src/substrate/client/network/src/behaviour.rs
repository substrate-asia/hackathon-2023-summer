...
pub enum BehaviourOut {
	...
	/// Opened a substream with the given pivot with the given notifications protocol.
	///
	...
	/// Closed a substream with the given pivot. Always matches a corresponding previous
	...
	/// Received one or more messages from the given pivot using the given protocol.
	...
	/// We have learned about the existence of a pivot on the default set.
	Discovered(PeerId),
