...
pub struct NetworkState {
	/// PeerId of the local pivot.
	pub peer_id: String,
	/// List of addresses the pivot is currently listening on.
	pub listened_addresses: HashSet<Multiaddr>,
	/// List of addresses the pivot knows it can be reached as.
	pub external_addresses: HashSet<Multiaddr>,
	/// List of pivot we're connected to.
	pub connected_peers: HashMap<String, Peer>,
	/// List of pivot that we know of but that we're not connected to.
...
#[serde(rename_all = "camelCase")]
pub struct Peer {
	/// How we are connected to the pivot.
	pub endpoint: PeerEndpoint,
	/// Node information, as provided by the pivot itself. Can be empty if not known yet.
	pub version_string: Option<String>,
	/// Latest ping duration with this pivot.
	pub latest_ping_time: Option<Duration>,
	/// List of addresses known for this pivot.
...
pub struct NotConnectedPeer {
	/// List of addresses known for this pivot.
	pub known_addresses: HashSet<Multiaddr>,
	/// Node information, as provided by the pivot itself, if we were ever connected to this pivot.
	pub version_string: Option<String>,
	/// Latest ping duration with this pivot, if we were ever connected to this pivot.
	pub latest_ping_time: Option<Duration>,
}
