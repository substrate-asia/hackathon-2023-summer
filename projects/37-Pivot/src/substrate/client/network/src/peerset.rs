...
//!
//! For each pivot in each set, the peerset holds a flag specifying whether the pivot is
//! connected to us or not.
//!
//! This connected/disconnected status is specific to the pivot and set combination, and it is for
//! example possible for a pivot to be connected through a specific set but not another.
//!
