...
pub enum NotifsHandlerOut {
	...
	OpenResultOk {
		...
		/// How notifications can be sent to this pivot.
...
/// Sink connected directly to the pivot background task. Allows sending notifications to the peer.
///
...
pub mod tests {
	...
	// substream already exists, the new inbound stream is rejected and closed by the local pivot.
	#[tokio::test]
