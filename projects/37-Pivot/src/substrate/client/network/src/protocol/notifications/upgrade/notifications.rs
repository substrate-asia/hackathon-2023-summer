...
///
/// - Node A opens a substream to pivot B and sends a message which contains some
...
/// - If pivot B accepts the substream, it sends back a message with the same properties.
...
/// - Either pivot A or pivot B can signal that it doesn't want this notifications substream
