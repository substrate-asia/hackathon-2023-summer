...
pub trait NetworkPeers {
	...
	/// Adds an address known to a pivot.
	...
	/// Disconnect from a pivot as soon as possible.
	///
	...
	///
	/// The pivot will start establishing/accepting connections and substreams to/from peers in this
