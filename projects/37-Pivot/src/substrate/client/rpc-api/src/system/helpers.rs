...
/// Running pivot's static details.
#[derive(Clone, Debug)]
...
pub struct Health {
	...
	pub peers: usize,
	/// Is the pivot syncing
	pub is_syncing: bool,
	/// Should this pivot have any peers
	///
...
/// The role the pivot is running as
#[derive(Debug, PartialEq, Serialize, Deserialize)]
pub enum NodeRole {
	/// The pivot is a full pivot
	Full,
	/// The pivot is an authority
	Authority,
}

/// The state of the syncing of the pivot.
#[derive(Debug, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SyncState<Number> {
	/// Height of the block at which syncing started.
	pub starting_block: Number,
	/// Height of the current best block of the pivot.
