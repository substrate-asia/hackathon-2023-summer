...
/// 2020-10-16 08:03:14  ⛓  Native runtime: pivot-template-1 (pivot-template-1.tx1.au1)
...
/// 2020-10-16 08:03:15  [light] 🏷  Local pivot identity is: 12D3KooWHX4rkWT6a6N55Km7ZnvenGdShSKPkzJ3yj9DU5nqDtWR
...
/// ```
///
/// # Example using the actual pivot name
///
/// ```ignore
/// Builds a new service for a light client.
...
/// 2020-10-16 08:12:57  ⛓  Native runtime: pivot-template-1 (pivot-template-1.tx1.au1)
...
/// 2020-10-16 08:12:58  [open-harbor-1619] 🏷  Local pivot identity is: 12D3KooWRzmYC8QTK1Pm8Cfvid3skTS4Hn54jc4AUtje8Rqbfgtp
...
pub fn prefix_logs_with(arg: TokenStream, item: TokenStream) -> TokenStream {
	...
	if arg.is_empty() {
		return Error::new(
			Span::call_site(),
			"missing argument: name of the pivot. Example: sc_cli::prefix_logs_with(<expr>)",
		)
		.to_compile_error()
		.into()
	}
