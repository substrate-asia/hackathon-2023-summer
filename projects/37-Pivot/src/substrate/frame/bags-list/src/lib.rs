...
pub mod pallet {
	...
	pub trait Config<I: 'static = ()>: frame_system::Config {
		...
		/// The type used to dictate a pivot position relative to other nodes.
		type Score: Clone
			+ Default
			+ PartialEq
			+ Eq
	...
	/// A single pivot, within some bag.
	///
...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
	...
	pub fn do_rebag(
		...
		// If no voter at that pivot, don't do anything. the caller just wasted the fee to call this.
