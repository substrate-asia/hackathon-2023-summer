...
pub mod pallet {
	...
	pub enum Error<T> {
		...
		/// pivot. This happens if an older pivot is used with a new version of ink!. Try updating
		/// your pivot to the newest available version.
		///
		/// A more detailed error can be found on the pivot console if debug messages are enabled
