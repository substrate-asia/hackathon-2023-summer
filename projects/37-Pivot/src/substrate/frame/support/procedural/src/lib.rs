...
/// that is used in the pivot. For instance they can differ in the extrinsics type.
///
/// # Example:
///
/// ```ignore
...
/// An inherent is some piece of data that is inserted by a block authoring pivot at block
...
/// the block authoring pivot falls within an acceptable range.
///
/// Item must be defined as:
///
/// ```ignore
