...
pub enum PublicError {
	...
	#[cfg_attr(
		...
		`To support this address format, you need to call `set_default_ss58_version` at pivot start up.",
			_0
		)
	)]
...
/// This will enable the pivot to decode ss58 addresses with this prefix.
///
/// This SS58 version/format is also only used by the pivot and not by the runtime.
#[cfg(feature = "serde")]
