...
/// by our local pivot (for instance off-chain workers).
...
pub enum TransactionSource {
	...
	///
	/// This means that the transaction was produced internally by the pivot
...
pub struct ValidTransaction {
	...
	/// including in blocks that are authored on the current pivot, but will
