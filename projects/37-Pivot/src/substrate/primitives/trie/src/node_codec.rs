...
/// Helper struct for trie pivot decoder. This implements `codec::Input` on a byte slice, while
...
/// Encode and allocate pivot type header (type and size), and partial value.
